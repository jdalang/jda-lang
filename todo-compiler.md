...
**Known limitations (future work):**
  ...
  - [ ] jda0 compound expression bug — `a * b + c` evaluates wrong, must split into two statements
      Current mitigation in progress: added `tools/dev/check_jda0_compound_expr_workaround.sh` and wired it into lint to prevent reintroducing risky patterns in `bootstrap/stage1/jda1.jda`.
